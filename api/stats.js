...
const NOTICE = [
  ...
  `그래도 소액 구간이 두꺼운 이유 — <b>타인 간 증여는 증여재산공제가 0원</b>이고, 친족이라도 10년 내 공제를 이미 쓴 <b>재차 증여</b>는 소액이어도 과세됩니다. 실제로 <b>1천만 이하</b> 구간도 건당 산출세액이 <b>${perOne(TAXB[0][5], TAXB[0][0])}</b>이고, 증여재산공제는 건당 ${perOne(TAXB[0][3], TAXB[0][0])}에 그칩니다 — 세금이 0원인 신고가 아닙니다. (아래 '구간별 세금' 표에서 확인)`,
