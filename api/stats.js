...
// ── 6.3.3 규모 구간 (증여재산가액 기준, 각 구간은 "직전 구간 초과 ~ 표기액 이하") ──
...
const NOTICE = [
  ...
  '구간은 <b>증여재산가액</b> 기준이며, 각 구간은 "직전 구간 초과 ~ 표기 금액 이하"입니다. (예: <b>5천만 이하</b> = 1천만 초과 ~ 5천만 이하)',
...
const PI_POINTS = {
  ...
  items: [
    ...
    { group: '10세 미만 — 가장 이른 증여', tag: '', lines: [
      ...
      '미성년 공제한도(10년 2천만원)를 조금 넘겨 신고하는 구간과 겹칩니다',
    ]},
...
const RAW = [
  { title: '2025년 증여재산가액 규모별 신고인원 — 전국',
